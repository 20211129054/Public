...
namespace uyg_vz.Controllers
{
    public class ServisController : ApiController
    {
        ...
        {
            List<SoruModel> liste = db.Soru.Where(s => s.soruAnketId == anketId).Select(x => new SoruModel()
            {
                soruId = x.soruId,
                soruAnketId = x.soruAnketId,
                soru = x.soru
        ...
        {
            List<SecenekModel> liste = db.Secenek.Where(s => s.secenekSoruId == soruId).Select(x => new SecenekModel()
            {
                secenekId = x.secenekId,
                secenekSoruId = x.secenekSoruId,
                secenek = x.secenek
